...
create table if not exists public.site_settings (
  ...
  name text not null default 'رَشفة',
  tagline text not null default 'نظام الحجوزات',
...
insert into public.items (name, category, price, emoji) values
  ('لاتيه ساخن', 'قهوة', 55, '☕'), ('كابتشينو', 'قهوة', 60, '🥛'), ('كولد برو', 'بارد', 65, '🧊'),
  ('شاي أخضر', 'ساخن', 35, '🍵'), ('كرواسون زبدة', 'مخبوزات', 45, '🥐'), ('تشيز كيك', 'حلويات', 75, '🍰');